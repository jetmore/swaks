...
Transport - The transport is the underlying method used to connect to the target.
...
> <~ transaction, Indicates a TLS-encrypted, expected line sent by target server to swaks
