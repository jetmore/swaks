...
This option is a direct alias to '--data -' (read DATA from STDIN).  It is totally secondary to --data.  Any occurrance of --data will cause -g to be ignored.  This option cannot be negated with the 'no-' prefix.  This option is deprecated and will be removed in a future version of Swaks.
